...
const things1 = ['scupltures<br><span id="whisper">(statuettes 3pts)</span>', 'someone feeding birds', 'birds in art', 'spiders', 'witches', 'vampires', 'ants', 'Harry Potter<br><span id="whisper">(Marauders 3pts)</span>', 'murals<br><span id="whisper">(wing murals 3pts)</span>', 'Mood Fabrics shopping bag', 'someone running in non-athletic clothing', 'someone in facepaint', 'pretty cakes<br><span id="whisper">(classically frosted 3pts)</span>', 'obvious siblings', 'miniatures', 'pink curtains', 'dandelions', 'an adult eating a sweet treat alone', 'leaves lit only by artificial light', 'pigeons', 'American Girl Doll', 'historical plaques', 'gargoyles', 'spiral staircases', 'Taylor Swift related', 'Chappell Roan related', 'rainbow sprinkles', 'dogs<br><span id="whisper">(in clothes 3pts)</span>', 'the number 3', 'the name Annie', 'cemeteries', 'someone making art', 'someone carrying something out of place or cumbersome', 'bench with a plaque<br><span id="whisper">(must read)</span>', 'anything birthday related', 'psychics', 'art on the ground', 'libraries', 'museums']
